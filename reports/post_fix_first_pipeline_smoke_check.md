# Post-Fix Pipeline Smoke Check — Round 16

**Generated:** 2026-06-10 08:14 UTC  
...
|---|---:|---:|---|
| Calendar days of post-fix squeeze_scores | ≥ 30 | **28** | ❌ |
| New-format rows total | ≥ 500 | **566** | ✅ |
| Rows with ARMED or ACTIVE state | ≥ 50 | **66** | ✅ |
| 20-day forward return windows closed | ≥ 100 rows | **220** | ✅ |
| Rows with non-null `risk_score` | ≥ 100 | **566** | ✅ |
| Rows with non-null `options_pressure_score` | ≥ 20 | **566** | ✅ |
