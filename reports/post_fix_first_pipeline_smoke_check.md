# Post-Fix Pipeline Smoke Check — Round 15

**Generated:** 2026-06-08 06:50 UTC  
...
| `state_warnings` | 0/21 | 0/21 (0%) — old-format |
...
| New-format rows total | ≥ 500 | **525** | ✅ |
| Rows with ARMED or ACTIVE state | ≥ 50 | **45** | ❌ |
| 20-day forward return windows closed | ≥ 100 rows | **220** | ✅ |
| Rows with non-null `risk_score` | ≥ 100 | **525** | ✅ |
| Rows with non-null `options_pressure_score` | ≥ 20 | **525** | ✅ |
